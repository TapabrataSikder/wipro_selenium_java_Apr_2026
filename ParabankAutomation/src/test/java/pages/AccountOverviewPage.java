...
//	By accountId = By.xpath("//table[@id='accountTable']//tr[1]/td[1]/a");
//	By balance = By.xpath("//table[@id='accountTable']//tr[1]/td[2]");
//	By availableAmount = By.xpath("//table[@id='accountTable']//tr[1]/td[3]");
...
//        return wait.until(ExpectedConditions.visibilityOfElementLocated(availableAmount)).getText();
//    }
