...
public class Update_table {
	...
	public static void main(String[] args)  {
		...
		// insert record
		String insertSQL="insert into students values(101,'Neeva Sharma',98,'abc@gmail.com', 21),"
				+ "(102,'Reeva Sharma',89,'Reeva@gmail.com', 23),"
				+ "(103,'Shiva Upadhyay',79,'shiva@gmail.com', 20)";
		...
		try
		{
			...
			String addCol = "alter table students add column age int";
			stmt.executeUpdate(addCol);
			System.out.println("New column 'city' added successfully.");
			
			String insertNewSQL = "insert into students values(104, 'Rahul Sikder', 92, 'rahul@gmail.com', 20)";
		    stmt.executeUpdate(insertNewSQL);
		    System.out.println("New record with age inserted.");
